...
export const deleteUserAllService = async (): Promise<DeleteAllResponse> => {
    ...
    // Garantindo que sempre retornamos o formato esperado
    return {
        count: result.rowCount || 0,  // Se rowCount for undefined, usa 0
        users: result.rows || []      // Se rows for undefined, usa array vazio
    };
};